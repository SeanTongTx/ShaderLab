Shader "Lapis/Cloth/Leather"
{
	...
	{ 
		...
		[Toggle(ENABLE_NORMALMAP)]FEATURE_NORMALMAP("Enable Normal Map", Float) = 1
		_NormalTex("Normal Texture",2D) = "white" {}

		[Toggle(ENABLE_RAMP_SPECULAR)]FEATURE_RAMP_SPECULAR("Enable Ramp Specular", Float) = 1
	...
	SubShader//LOD 400
	{
		...
		Pass//Base
		{
			...
			#pragma shader_feature_local ENABLE_RAMP_SPECULAR
			#include "../Object/Cgincs/Leather.cginc"
			ENDCG
		}
