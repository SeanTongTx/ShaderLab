...
Shader "ShaderLab/Lapis/Effect/SandClock" {
    Properties {
        ...
        _Color_Deflection ("Color_Deflection", Range(0, 3)) = 0.9059829
...
////// Emissive:
                ...
                float3 emissive = (lerp(_Color_Inside.rgb,_Color_Outer.rgb,pow(1.0-max(0,dot(normalDirection, viewDirection)),_Color_Deflection))+(_VeinTex_var.rgb*_VeinInt));
