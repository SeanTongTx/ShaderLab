...
Shader "ShaderLab/Lapis/Effect/SpeedLine" {
    Properties {
        ...
        _Width ("Width", Range(0, 1)) = 0.3974359
...
////// Emissive:
                ...
                float4 node_863 = _Time + _TimeEditor;
